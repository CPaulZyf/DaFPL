...
class DatasetBase:
    ...
    def __init__(self, train_x=None, federated_train_x=None, federated_val_x=None, train_u=None, val=None, federated_test_x=None, test=None):
        self._train_x = train_x  # labeled training data
        self._federated_train_x = federated_train_x
        self.federated_val_x = federated_val_x# federated labeled training data (optional)
